...
class Reservation(models.Model):
    user = models.ForeignKey(User) # Chave estrangeira para o usuário
    room = models.ForeignKey(Room) # Chave estrangeira para a sala
    ...
    commentary = models.TextField(max_length = 200)  # campo para armazenar comentario da reserva 
    deleted_at = models.DateTimeField(null = True, blank = True) # Campo para gerenciar a exclusão do registro
